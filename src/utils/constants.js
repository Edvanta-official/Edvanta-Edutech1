export const NAV_LINKS = [
  ...
  { name: 'LMS Portal', path: 'https://lms.edvanta-edu.com/', external: true },
...
export const FAQS = [
  {
    ...
    answer: 'Our internships typically run for 4 months, offering flexible hours to accommodate college coursework.'
  },
  {
